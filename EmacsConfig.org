...
#+begin_src emacs-lisp
  ...
  (use-package org-download
    ...
    (org-download-headingorg-download-screenshot-method-lvl nil)
...
#+RESULTS:
| (lambda nil (add-hook 'after-save-hook #'drudge/org-babel-tangle-config)) | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-show-all append local] 5] | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-babel-show-result-all append local] 5] | org-babel-result-hide-spec | org-babel-hide-all-hashes | drudge/org-mode-setup | (lambda nil (display-line-numbers-mode 0)) |
...
;    (find-file (concat (file-name-directory user-init-file) "EmacsConfig.org")))
    (find-file "~/github/emacs-init/EmacsConfig.org"))
