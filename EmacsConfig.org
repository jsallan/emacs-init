...
#+begin_src emacs-lisp
  ...
  ;;       (plain-list-item . always)))
    ...
    ;; date-time format
      ...
      ;; (setq org-agenda-files system-specific-org-roam-directory)
      (setq org-agenda-files (directory-files-recursively system-specific-org-roam-directory "\\.org$"))
...
#+end_src
*** dired setup for side window
Taken from https://org-roam.discourse.group/t/org-roam-dailies-how-to-browse-through-previous-days/1018/6
